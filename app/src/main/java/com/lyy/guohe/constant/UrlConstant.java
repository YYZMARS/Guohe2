...
public class UrlConstant {
    ...
    public static final String APP = "https://www.guohe3.com";           //APP官网网址
    ...
    //抽奖页面
    public static final String LOTTERY = "http://jihangyu.cn/lottery/index.html?username=";
    //获取天气的接口
    public static final String WEATHER = "http://api.jirengu.com/getWeather.php?city=镇江";
    //广告位接口
    public static final String HEAD_PIC = "https://guohe3.com/getAd";
    //彩蛋接口
    public static final String EGG = "http://p7gzvzwe4.bkt.clouddn.com/111.gif";
    //校园热线
    public static final String SCHOOL_TEL = "https://mp.weixin.qq.com/s?__biz=MzA5MDQ1MTU5OQ==&mid=203948380&idx=1&sn=38768267f5611e44b0ad2480559a463c#wechat_redirect";
    //果核每日一句接口
