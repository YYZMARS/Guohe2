...
import com.lyy.guohe2.adapter.BookDetailAdapter;
...
public class BookDetail extends AppCompatActivity {
    ...
    private List<com.lyy.guohe2.model.BookDetail> bookDetailList = new ArrayList<>();
                    ...
                    if (res.getCode() == 200) {
                        try {
                            ...
                            for (int i = 0; i < array.length() - 1; i++) {
                                ...
                                com.lyy.guohe2.model.BookDetail bookDetail = new com.lyy.guohe2.model.BookDetail(call_number, barcode, finalPlace);
